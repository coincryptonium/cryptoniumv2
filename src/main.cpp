...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Cryptoniumcoin V2";
        CTransaction txNew;
        txNew.nTime = 1501168752;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1501168752;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 3545269 : 3545269;
        ...
        assert(block.hashMerkleRoot == uint256("0x350ddc823db9f1aede53d688400ac448e00a630c8f8a55b09b04bb8a5ea2169c"));
